...
public class BST<Key extends Comparable<Key>, Value> {
     ...
     *
     * @throws Exception if the symbol table is empty
     */
     ...
     * @throws Exception   if there is no such key
     * @throws IllegalArgumentException if {@code key} is {@code null}
     */
    ...
    public Key ceiling(Key key) throws Exception {
        ...
        if (isEmpty()) throw new Exception("calls ceiling() with empty symbol table");
     ...
     */
    public Iterable<Key> levelOrder() throws Exception {
